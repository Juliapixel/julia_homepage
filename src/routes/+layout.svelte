<script lang="ts">
    ...
    import { baseLocale, defineCustomClientStrategy, extractLocaleFromNavigator, extractLocaleFromUrl, localStorageKey, type Locale } from "$lib/paraglide/runtime";
    ...
    defineCustomClientStrategy("custom-Wah", {
        getLocale: () => {
            const local = (localStorage.getItem(localStorageKey) as Locale | null)
