...
<p>{$_("sim.mit.0")}:</p>
<div
    class="inline-flex max-w-full flex-nowrap rounded-lg p-5 overflow-auto [text-shadow:none] text-sm text-neutral-200 bg-zinc-900 border border-zinc-700"
>
